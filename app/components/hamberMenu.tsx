...
function HamberMenu() {
  ...
  return (
    <>
      ...
      />
      {menuIsOpen && (
        <div className="bg-white dark:bg-DarkBlue bg-opacity-80 backdrop-blur-sm absolute h-dvh top-20 w-dvw left-0 right-0 px-4 pt-3">
          <ul
            className={
          ...
          >
            <li className={'flex h-10 items-center justify-start'}>
              <Link
                className={'w-full h-full flex justify-start items-center pl-7'}
