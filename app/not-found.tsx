            ...
            <ul className="divide-y">
              {navigations.map((item, idx) => (
                <li key={idx} className="flex gap-x-4 py-6">
                  <div className="flex-none w-14 h-14 bg-indigo-50 rounded-full text-LightBlue flex items-center justify-center">
                    {item.icon}
                  </div>
                  <div className="space-y-1">
                    ...
                    <a
                      href={item.href}
                      className="text-sm text-LightBlue duration-150 hover:text-LightBlue/80 font-medium inline-flex items-center gap-x-1"
                    >
                      Learn more
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
