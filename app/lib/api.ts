...
export async function fetchCryptoData(cryptoId: string): Promise<CryptoData> {
  ...
  return {
    ...
    news: [
      {
        title: "Polkadot Releases Major Network Upgrade Enhancing Cross-Chain Communication",
        description:
      ...
      {
        title: "Polkadot Ecosystem Sees Surge in Developer Activity According to New Report",
        description:
